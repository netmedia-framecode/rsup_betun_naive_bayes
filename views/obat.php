...
$_SESSION["page-name"] = "Obat";
$_SESSION["page-url"] = "obat";
?>
                          ...
                          <?php if (mysqli_num_rows($obat) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($obat)) { ?>
                              <tr>
                                ...
                                <td><textarea style="width: 100%;line-height: 15px;" cols="30" rows="5" readonly><?= $row["obat"] ?></textarea></td>
                                <td class="d-flex justify-content-center">
                                  <div class="col">
                                    <button type="button" class="btn btn-warning btn-sm text-white rounded-0 border-0" style="height: 30px;" data-bs-toggle="modal" data-bs-target="#ubah<?= $row["id_obat"] ?>">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header border-bottom-0 shadow">
                                            <h5 class="modal-title" id="exampleModalLabel">Ubah obat penyakit <?= $row["nama_penyakit"] ?></h5>
                                          ...
                                          <form action="" method="POST">
                                            <div class="modal-body text-center">
                                              ...
                                              <div class="mb-3">
                                                ...
                                                <textarea name="obat" id="obat" class="form-select" cols="30" rows="5" required><?= $row['obat'] ?></textarea>
                                              </div>
                                            </div>
                                            <div class="modal-footer justify-content-center border-top-0">
                                              ...
                                              <button type="submit" name="ubah-obat" class="btn btn-warning btn-sm rounded-0 border-0" style="height: 30px;">Ubah</button>
                                            </div>
                                          </form>
                                        </div>
                                      </div>
                                  ...
                                  <div class="col">
                                    <button type="button" class="btn btn-danger btn-sm text-white rounded-0 border-0" style="height: 30px;" data-bs-toggle="modal" data-bs-target="#hapus<?= $row["id_obat"] ?>">
                                    ...
                                    <div class="modal fade" id="hapus<?= $row["id_obat"] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header border-bottom-0 shadow">
                                            <h5 class="modal-title" id="exampleModalLabel">Hapus obat penyakit <?= $row["nama_penyakit"] ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                          </div>
                                          <div class="modal-body text-center">
                                          ...
                                          <div class="modal-footer justify-content-center border-top-0">
                                            ...
                                            <form action="" method="POST">
                                              <input type="hidden" name="id_obat" value="<?= $row["id_obat"] ?>">
                                              <button type="submit" name="hapus-obat" class="btn btn-danger btn-sm rounded-0 text-white border-0" style="height: 30px;">Hapus</button>
                                            </form>
                                          </div>
                                        </div>
                                      </div>
            ...
            <div class="modal-content">
              ...
              <form action="" method="post" name="random_form">
                <div class="modal-body text-center">
                  ...
                  <div class="mb-3">
                    <label for="obat" class="form-label">Obat <small class="text-danger">*</small></label>
                    <textarea name="obat" id="obat" class="form-select" cols="30" rows="5" required></textarea>
                  </div>
                </div>
                <div class="modal-footer border-top-0 justify-content-center">
                  <button type="button" class="btn btn-secondary btn-sm rounded-0" data-bs-dismiss="modal">Batal</button>
                  <button type="submit" name="tambah-obat" class="btn btn-primary btn-sm rounded-0 border-0">Simpan</button>
                </div>
              </form>
            </div>
          </div>
