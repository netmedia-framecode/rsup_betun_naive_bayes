...
$_SESSION["page-name"] = "Penyakit";
$_SESSION["page-url"] = "penyakit";
?>
                  ...
                  <div class="card rounded-0 mt-3">
                    <div class="card-body table-responsive">
                      <table class="table table-striped table-hover table-borderless table-sm display" id="datatable">
                        ...
                        <tbody>
                          <?php if (mysqli_num_rows($penyakit) > 0) {
                            $no = 1;
                            while ($row = mysqli_fetch_assoc($penyakit)) { ?>
                              <tr>
                                <th scope="row" class="text-center"><?= $no; ?></th>
                                <td class="text-center"><?= $row["kode_penyakit"] ?></td>
                                <td><?= $row["nama_penyakit"] ?></td>
                                <td class="d-flex justify-content-center">
                                  <div class="col">
                                    <button type="button" class="btn btn-warning btn-sm text-white rounded-0 border-0" style="height: 30px;" data-bs-toggle="modal" data-bs-target="#ubah<?= $row["id_penyakit"] ?>">
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <form action="" method="POST">
                                            <div class="modal-body text-center">
                                              <div class="mb-3">
                                                <label for="nama_penyakit" class="form-label">Penyakit <small class="text-danger">*</small></label>
                                                <input type="nama_penyakit" name="nama_penyakit" value="<?= $row["nama_penyakit"] ?>" class="form-control text-center" id="nama_penyakit" placeholder="Penyakit" required>
                                              </div>
                                            </div>
                                            <div class="modal-footer justify-content-center border-top-0">
                                              ...
                                              <button type="submit" name="ubah-penyakit" class="btn btn-warning btn-sm rounded-0 border-0" style="height: 30px;">Ubah</button>
                                            </div>
                                          </form>
                                        </div>
                                      </div>
                                  ...
                                  <div class="col">
                                    <button type="button" class="btn btn-danger btn-sm text-white rounded-0 border-0" style="height: 30px;" data-bs-toggle="modal" data-bs-target="#hapus<?= $row["id_penyakit"] ?>">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer justify-content-center border-top-0">
                                            ...
                                            <form action="" method="POST">
                                              <input type="hidden" name="id_penyakit" value="<?= $row["id_penyakit"] ?>">
                                              <button type="submit" name="hapus-penyakit" class="btn btn-danger btn-sm rounded-0 text-white border-0" style="height: 30px;">Hapus</button>
                                            </form>
                                          </div>
                                        </div>
                                      </div>
            ...
            <div class="modal-content">
              ...
              <form action="" method="post" name="random_form">
                ...
                <div class="modal-footer border-top-0 justify-content-center">
                  ...
                  <button type="submit" name="tambah-penyakit" class="btn btn-primary btn-sm rounded-0 border-0">Simpan</button>
                </div>
              </form>
            </div>
          </div>
